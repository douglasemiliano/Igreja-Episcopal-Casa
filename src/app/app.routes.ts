...
/** Perfis com acesso à Central. 'membro' fica de fora de propósito. */
const CENTRAL = ['administrador', 'secretaria', 'caixa', 'tesouraria', 'pastor', 'lider'];
...
export const routes: Routes = [
    ...
    { path: 'central', component: HomeComponent, canActivate: [AuthGuard, RoleGuard], data: { roles: CENTRAL } },
