...
export const routes: Routes = [
    ...
    { path: 'lecionario/listar', loadComponent: () => import('./components/lecionario/listar-lecionario/listar-lecionario.component').then(c => c.ListarLecionarioComponent), canActivate: [AuthGuard, RoleGuard], data: { roles: ['administrador', 'secretaria'] } },
    ...
    { path: 'lecionario/cadastro', loadComponent: () => import('./components/lecionario/cadastro-lecionario/cadastro-lecionario.component').then(c => c.CadastroLecionarioComponent), canActivate: [AuthGuard, RoleGuard], data: { roles: ['administrador', 'secretaria'] } },
    { path: 'certificado', loadComponent: ()=> import('./components/certificado/certificado.component').then(c => c.CertificadoComponent), canActivate: [AuthGuard, RoleGuard], data: { roles: ['administrador', 'secretaria'] }},
    ...
    { path: 'membros/cadastrar', loadComponent: () => import('./components/membros/cadastrar-membro/cadastrar-membro.component').then(c => c.CadastrarMembroComponent), canActivate: [AuthGuard, RoleGuard], data: { roles: ['administrador', 'secretaria'] } },
